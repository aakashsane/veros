...
class ACCBasicSetup(VerosSetup):
    ...
    def set_parameter(self, state):
        ...
        settings.nx, settings.ny, settings.nz = 60, 84, 30
        settings.dt_mom = 1200
        ...
        settings.A_h = (2 * settings.degtom) ** 3 * 2e-5 #2e-11
    ...
    def set_grid(self, state):
        ...
        ddz = npx.array(
            [50.        ,  72.4137931 ,  94.82758621, 117.24137931,
       139.65517241, 162.06896552, 184.48275862, 206.89655172,
       229.31034483, 251.72413793, 274.13793103, 296.55172414,
       318.96551724, 341.37931034, 363.79310345, 386.20689655,
       408.62068966, 431.03448276, 453.44827586, 475.86206897,
       498.27586207, 520.68965517, 543.10344828, 565.51724138,
       587.93103448, 610.34482759, 632.75862069, 655.17241379,
       677.5862069 , 700.  ]
        )
    ...
    def set_diagnostics(self, state):
        ...
        diagnostics["averages"].output_frequency = 10 * 86400.0
